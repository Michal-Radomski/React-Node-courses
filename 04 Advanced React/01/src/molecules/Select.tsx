//* Code not checked!
import React, { useState, useRef, useEffect, type KeyboardEventHandler, createRef } from "react";
...
const Select: React.FunctionComponent<SelectProps> = ({
  ...
  useEffect(() => {
    ...
    setOptionRefs(options.map((_option) => createRef<HTMLLIElement>()));
  ...
  }, [isOpen, highlightedIndex, optionRefs]);
...

      {
        ...
        >
          {options.map((option, optionIndex) => {
            ...
            return (
              <li {...renderOptionProps.getOptionRecommendedProps()} key={optionIndex}>
