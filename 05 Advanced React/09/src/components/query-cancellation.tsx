...
const QueryCancellationWithAbortSignal = (): JSX.Element => {
  const [shouldAbort, setShouldAbort] = React.useState<boolean>(true);
    ...
    <React.Fragment>
      <Container>
        <div>
          ...
          <div>
            <CheckboxLabel>
              <CheckboxInput type="checkbox" checked={shouldAbort} onChange={() => setShouldAbort((checked) => !checked)} />
              Abort
            </CheckboxLabel>
          </div>
