import React from "react"; // Importing ChangeEventHandler and useId hook from React
...
const LabeledInput = ({ label, value, id, className, type = "text", onChange }: LabeledInputProps): JSX.Element => {
